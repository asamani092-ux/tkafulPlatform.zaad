...
const DonorLayout = ({ children, currentPage, onPageChange }) => {
      ...
      <div className={`fixed inset-y-0 right-0 z-50 w-64 bg-white shadow-lg transform ${sidebarOpen ? 'translate-x-0' : 'translate-x-full'} transition-transform duration-300 ease-in-out lg:translate-x-0 lg:static lg:inset-0`}>
        <div className="flex items-center justify-between h-16 px-6 border-b border-gray-200">
          <div className="flex items-center space-x-3 space-x-reverse">
            ...
            <div>
              <h2 className="text-lg font-bold text-alzad-burgundy">بوابة المتبرع</h2>
            </div>
          </div>
          <button
        ...
        <div className="absolute bottom-0 w-full p-4 border-t border-gray-200">
          <div className="flex items-center space-x-3 space-x-reverse mb-3">
            ...
            <div className="flex-1">
              <div className="text-sm font-medium text-gray-900">أحمد محمد السالم</div>
              <div className="text-xs text-gray-500">متبرع نشط</div>
            </div>
          </div>
          <Button 
            variant="outline" 
          ...
          <div className="flex items-center justify-between h-16 px-6">
            <div className="flex items-center space-x-4 space-x-reverse">
              ...
              <div className="relative hidden md:block">
                ...
                <input
                  type="text"
                  placeholder="البحث في فرص التبرع..."
