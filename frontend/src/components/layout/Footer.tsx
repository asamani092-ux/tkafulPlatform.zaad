...
/** تذييل وفق النموذج المعتمد: سطح فاتح + عناوين بنص العلامة. */
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-brand-gray">
              ...
              <li><Link to="/volunteers" className="hover:text-primary">المتطوعون</Link></li>
              <li><Link to="/map" className="hover:text-primary">الخرائط</Link></li>
