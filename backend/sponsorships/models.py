...
class SupplierProfile(models.Model):
    ...
    class Meta:
        # نُقل النموذج من saqya بدون لمس البيانات (D-02) — الجدول الأصلي نفسه
        db_table = "saqya_supplierprofile"
...
class RepresentativeProfile(models.Model):
    ...
    class Meta:
        db_table = "saqya_representativeprofile"
