...
class SponsorshipViewSet(viewsets.ModelViewSet):
    ...
    def pay(self, request, pk=None):
        ...
        # المنطق في services.record_payment (fat models, thin views) — نفس السلوك حرفياً
        try:
            payment, sp = sponsorship_services.record_payment(
                sponsorship_id=pk,
                user=request.user,
        ...
        except sponsorship_services.PaymentError as exc:
