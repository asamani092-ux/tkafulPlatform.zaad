...
## D-20 — ضبط الشعار
- `logo-alzad.svg` أُعيد رسمه وفق المرجع: شكل عنابي كقطرة بزاويتين حادتين، حبوب سنبلة
  مدببة، هلال أصفر ملتف أسفل-يسار، «جمعية» بإطار مفرّغ بنص عنابي، «الزاد» بوزن 800.
- يبقى الاسم ثابتاً ليُستبدل بالأصل الرسمي بخطوة واحدة متى توفّر.
