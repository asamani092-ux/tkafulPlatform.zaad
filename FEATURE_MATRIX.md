...
> **تحديث UX3 (الجولة الثالثة):** لا إعادة تحميل عند الحفظ في الإدارة؛ نموذج مشروع
> متدرّج؛ كفالات صفّاً بصفّ؛ ربط النماذج + QR؛ دخول موحّد للأدوار (`roles_can_login`)؛
> حذف طبقات/حقول/عناصر الخرائط؛ محتوى الصفحة الرئيسية و«من نحن» عبر `StaticPage` (CMS).
