...
## إعدادات الدخول والكفالة (قابل للتهيئة)

| الإجراء | Anon | user | donor (roles_can_login) | admin/manager |
|--------|------|------|---------------------------|---------------|
| `POST /api/accounts/auth/token/` | ✅ إن الدور مسموح | ✅ | ✅ فقط إن `roles_can_login.donor` | ✅ |
| `POST /api/saqya/sponsorships/` إنشاء | 🚫 | 🚫 | ✅ إن مسموح الدخول | ✅ تسجيل إداري |
